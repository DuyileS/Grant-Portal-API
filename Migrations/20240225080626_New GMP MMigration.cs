...
{
    /// <inheritdoc />
    public partial class NewGMPMMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateUploaded = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applicants_Documents_DocumentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Awardees", x => x.AwardeeId);
                    table.ForeignKey(
                        name: "FK_Awardees_Documents_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "Documents",
                        principalColumn: "DocumentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GrantApplicants", x => new { x.GrantId, x.ApplicantId });
                    table.ForeignKey(
                        name: "FK_GrantApplicants_Applicants_ApplicantId",
                        column: x => x.ApplicantId,
                        principalTable: "Applicants",
                        principalColumn: "ApplicantId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GrantApplicants_Grants_GrantId",
                        column: x => x.GrantId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applicants_DocumentId",
                table: "Applicants",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_Awardees_DocumentId",
                table: "Awardees",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_GrantApplicants_ApplicantId",
                table: "GrantApplicants",
                column: "ApplicantId");
        }
